...
export async function flushPrivateV6(): Promise<Array<string>> {
	return returnDirectly('PrivateV6', ['::1/128', 'fc00::/7', 'fe80::/10']);
}

export async function flushPrivate(): Promise<Array<string>> {
	return await getFromSub('Private', flushPrivateV4, flushPrivateV6);
}
